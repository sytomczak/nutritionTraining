...
class DailyDemandCalculationTest {
    ...
    public static Stream<Arguments> provideDataForDemandCalculation() {
        return Stream.of(
                ...
                Arguments.of(new CalculationResult(31.51, 2690), Gender.FEMALE, 36, 90, 169, Physique.MESOMORPH, DailyActivityLevel.HIGH, 2, 70, IntensityOfAerobicWorkoutsLevel.LOW, 5, 30, IntensityOfStrongWorkoutsLevel.HIGH),
                Arguments.of(new CalculationResult(17.96, 2134), Gender.FEMALE, 24, 55, 175, Physique.ENDOMORPH, DailyActivityLevel.MEDIUM, 3, 20, IntensityOfAerobicWorkoutsLevel.HIGH, 3, 60, IntensityOfStrongWorkoutsLevel.MEDIUM),
                Arguments.of(new CalculationResult(29.14, 1965), Gender.FEMALE, 21, 70, 155, Physique.ENDOMORPH, DailyActivityLevel.LOW, 6, 30, IntensityOfAerobicWorkoutsLevel.MEDIUM, 1, 45, IntensityOfStrongWorkoutsLevel.LOW),
                ...
                Arguments.of(new CalculationResult(34.6, 2998), Gender.MALE, 32, 100, 170, Physique.ENDOMORPH, DailyActivityLevel.HIGH, 1, 80, IntensityOfAerobicWorkoutsLevel.HIGH, 4, 70, IntensityOfStrongWorkoutsLevel.MEDIUM),
                Arguments.of(new CalculationResult(20.76, 2748), Gender.MALE, 48, 60, 170, Physique.ECTOMORPH, DailyActivityLevel.MEDIUM, 5, 40, IntensityOfAerobicWorkoutsLevel.MEDIUM, 1, 40, IntensityOfStrongWorkoutsLevel.LOW),
                Arguments.of(new CalculationResult(17.72, 1893), Gender.MALE, 62, 50, 168, Physique.MESOMORPH, DailyActivityLevel.LOW, 3, 10, IntensityOfAerobicWorkoutsLevel.LOW, 3, 20, IntensityOfStrongWorkoutsLevel.LOW)
        );
    }
}